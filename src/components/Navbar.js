        ...
        <nav className="bg-white border-gray-200 shadow sticky top-0 py-2 z-[100]">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex md:order-2">
                    <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium duration-300  rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0">Hire Me</button>
