                    ...
                    <div className="mt-12 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">
                        <blockquote className="rounded-lg bg-gray-100 p-8">
                            ...
                            <p className="line-clamp-2 sm:line-clamp-none mt-4 text-gray-500">
                                A masterfully designed website for my startup, Unipitch—seamless functionality and impressive aesthetics
                            </p>
                        </blockquote>
                        ...
                        <blockquote className="rounded-lg bg-gray-100 p-8">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-lg font-medium text-gray-700">Prashant</p>
                                </div>
                            </div>

                            <p className="line-clamp-2 sm:line-clamp-none mt-4 text-gray-500">
                                Exceptional full-stack developer, seamlessly merges front-end creativity with back-end proficiency. A true asset.
                            </p>
                        </blockquote>
                        ...
                        <blockquote className="rounded-lg bg-gray-100 p-8">
                            ...
                            <p className="line-clamp-2 sm:line-clamp-none mt-4 text-gray-500">
                                A master of code: crafting dynamic frontends, robust backends. A fullstack virtuoso worth applauding.
                            </p>
                        </blockquote>
                    </div>
                </div>
